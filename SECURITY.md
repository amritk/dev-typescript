...
This is a generated TypeScript SDK for Test it, produced by the Scalar SDK Generator (https://scalar.com).
...
If the issue is in the Test it API or service rather than in this SDK, report it through the security process Test it has published.
